...
exports.realizarLogin = async (req, res) => {
    ...
    try {
        ...
        // Se for cliente
        return res.redirect('/barbearia-app/barbearia'); 
...
exports.renderCadastro = async (req, res) => {
    const barbearia = await buscarBarbeariaFixa();
    res.render('auth/cadastro', { erro: null, redirect: '/barbearia-app/barbearia', barbearia });
};
...
exports.googleCallback = async (req, res) => {
    try {
        ...
        if (usuarioTipo === 'dono' || usuarioTipo === 'colaborador') {
            ...
            res.redirect('/barbearia-app/barbearia');
        }
